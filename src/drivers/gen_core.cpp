...
int gen_core_open(nit_mb_core_state_t *state)
{
    ...
    state->priv = (volatile int *)memory_map_open(NULL, NIT_GEN_CORE_SIZE, PROT_READ | PROT_WRITE, MAP_SHARED, state->fd, NIT_GEN_CORE_BASE_ADDRESS);
...
int nit_gen_core_change_op_mode_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_change_op_mode_offset, value);
...
int nit_gen_core_digital_in_0_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_in_0_offset, value);
...
int nit_gen_core_digital_in_1_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_in_1_offset, value);
...
int nit_gen_core_digital_out_0_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_out_0_offset, value);
...
int nit_gen_core_digital_out_1_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_out_1_offset, value);
...
int nit_gen_core_digital_out_2_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_out_2_offset, value);
...
int nit_gen_core_digital_out_3_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_out_3_offset, value);
...
int nit_gen_core_digital_out_conf_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_digital_out_conf_offset, value);
...
int nit_gen_core_enable_roi_set(nit_mb_core_state_t *state, uint16_t value)
{
    ...
    unsafe_set<typeof(*state), uint32_t>(state, nit_gen_core_enable_roi_offset, value);
