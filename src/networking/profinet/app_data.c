...
//             (p_subslot->submodule_id == APP_GSDML_SUBMOD_ID_DIGITAL_IN || p_subslot->submodule_id == APP_GSDML_SUBMOD_ID_DIGITAL_IN_OUT))
//          {
...
static void app_handle_event_timer(app_data_t *app)
{
   ...
   /**
    *
    * This works as a "button reset on the API state machine"
    *
    * if removed it won't work.
    *
    */
   ...
   // /**
   //  * to emulate the behaviour for now I will try the following
   //  */
