#ifndef _nit_embedded_server_ctrl_dbus_config_hpp_
#define _nit_embedded_server_ctrl_dbus_config_hpp_
...
struct server_ctrl_dbus_config
{
...
namespace boost::serialization
{
	...
	void serialize(archiver& ar, server_ctrl_dbus_config& obj, unsigned)
	{
