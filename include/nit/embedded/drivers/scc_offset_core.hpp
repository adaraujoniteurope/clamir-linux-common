#ifndef nit_embedded_drivers_scc_offset_core_hpp_
#define nit_embedded_drivers_scc_offset_core_hpp_
...
{
    class scc_offset_core : public memory_mapped_device<scc_offset_core>
    {
    public:

        scc_offset_core(size_t offset = 0x4A000000, size_t size = 0x0001000, std::string path = "/dev/mem") : memory_mapped_device<scc_offset_core>(offset, size, path, nullptr)
        {
        }
