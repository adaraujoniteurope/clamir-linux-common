#ifndef nit_embedded_drivers_scc_scale_core_hpp_
#define nit_embedded_drivers_scc_scale_core_hpp_
...
{
    class scc_scale_core : public memory_mapped_device<scc_scale_core>
    {
    public:

        scc_scale_core(size_t offset = 0x48000000, size_t size = 0x0001000, std::string path = "/dev/mem") : memory_mapped_device<scc_scale_core>(offset, size, path, nullptr)
        {
        }
